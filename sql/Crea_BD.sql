/*
Empresa        :  Dircon Solutions
Software       :  Sistema de Incidencias - CRM
DBMS           :  MySQL Server
Base de Datos  :  Dircrm
Script         :  Crea la Base de Datos
Responsable    :  Luis Junior Ruiz Peralta
Telefono       :  (511) 944-267-001
Email          :  ljruizperalta@gmail.com
Sitio Web      :  -
Blog           :  -
*/
...
CREATE DATABASE IF NOT EXISTS Dircrm;
...
CREATE TABLE Usuario (
    int_usercodigo       INTEGER NOT NULL AUTO_INCREMENT,
    chr_emplcodigo       CHAR(4) NOT NULL,
    vch_userusuario      VARCHAR(15) NOT NULL,
    vch_userclave        VARCHAR(15) NOT NULL,
    CONSTRAINT PK_Usuario 
        PRIMARY KEY (int_usercodigo),
    CONSTRAINT fk_usuario_empleado
        FOREIGN KEY (chr_emplcodigo)
        REFERENCES Empleado (chr_emplcodigo)
        ON DELETE RESTRICT
        ON UPDATE RESTRICT, 
    CONSTRAINT U_Usuario_vch_userusuario
        UNIQUE (vch_userusuario)
);
